...
set MODE=%~1
if "%MODE%"=="" set MODE=radius
set DURATION=%~2
if "%DURATION%"=="" set DURATION=00:02:00
set N=%~3
if "%N%"=="" set N=100000

set RUNNER_DLL=tools\Hw2.ProfileRunner\bin\Release\net10.0\Hw2.ProfileRunner.dll
...
if not exist "%RUNNER_DLL%" (
  ...
  dotnet build tools\Hw2.ProfileRunner\Hw2.ProfileRunner.csproj -c Release
