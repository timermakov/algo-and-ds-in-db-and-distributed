...
dotnet run --project benchmarks\Hw2.Benchmarks\Hw2.Benchmarks.csproj -c Release -- --filter * --exporters json csv markdown
if exist BenchmarkDotNet.Artifacts\results\* copy /Y BenchmarkDotNet.Artifacts\results\* report\artifacts\ >nul
if exist benchmarks\Hw2.Benchmarks\BenchmarkDotNet.Artifacts\results\* copy /Y benchmarks\Hw2.Benchmarks\BenchmarkDotNet.Artifacts\results\* report\artifacts\ >nul
